//! Fleet transport for eidos (ADR-0023): node identity, approved joining, and the
...
//! - [`enroll`]: the approval-based join exchange.
//! - [`discovery`]: link-local master advertisement and discovery.
...
pub use config::{FleetConfig, PendingJoinTarget};
