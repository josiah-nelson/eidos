...
bounded synthetic measurement procedure. Coordinated-control tests cover
complete custom tuples, preserved source caps, partial component writes,
manual-write conflicts, repair and restart replay; see
[coordinated resource settings](coordinated-resource-settings.md).
Memory-diagnostics tests cover the
